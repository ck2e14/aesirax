...
const MAGIC_WORD = "DICM", PREAMBLE_LENGTH = 128, MAGIC_WORD_START = PREAMBLE_LENGTH, MAGIC_WORD_END = PREAMBLE_LENGTH + 4;
/**
    ...
    return new Promise((resolve, reject) => {
        ...
        readStream.on("data", (chunk) => {
            ...
            if (!truncatedPrevTag) {
                ...
                write(`Stitching previous tag to current chunk: ${truncatedPrevTag.length} + ${chunk.length} bytes`, "DEBUG");
