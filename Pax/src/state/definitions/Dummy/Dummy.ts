import { Action, Rule, State, StateMachine, Workflow, Event } from "../../abstractStateMachine";
/**
 * Dummy TLHC State Machine
...
export class DummyStateMachine extends StateMachine {
